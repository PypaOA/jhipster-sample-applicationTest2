...
export const DepartmentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationTest2App.department.delete.question">
        <Translate contentKey="jhipsterSampleApplicationTest2App.department.delete.question" interpolate={{ id: departmentEntity.id }}>
