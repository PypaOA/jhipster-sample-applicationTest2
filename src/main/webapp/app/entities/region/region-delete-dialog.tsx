...
export const RegionDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationTest2App.region.delete.question">
        <Translate contentKey="jhipsterSampleApplicationTest2App.region.delete.question" interpolate={{ id: regionEntity.id }}>
