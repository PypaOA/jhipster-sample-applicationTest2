  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationTest2App.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplicationTest2App.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplicationTest2App.location.streetAddress')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationTest2App.location.postalCode')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationTest2App.location.city')}
                id="location-city"
                name="city"
                data-cy="city"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationTest2App.location.stateProvince')}
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('jhipsterSampleApplicationTest2App.location.country')}
                type="select"
              >
                <option value="" key="0" />
                {countries
