...
export const LocationDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationTest2App.location.delete.question">
        <Translate contentKey="jhipsterSampleApplicationTest2App.location.delete.question" interpolate={{ id: locationEntity.id }}>
