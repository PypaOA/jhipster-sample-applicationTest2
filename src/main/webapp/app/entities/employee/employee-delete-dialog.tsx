...
export const EmployeeDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationTest2App.employee.delete.question">
        <Translate contentKey="jhipsterSampleApplicationTest2App.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
