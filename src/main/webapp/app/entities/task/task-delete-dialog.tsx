...
export const TaskDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationTest2App.task.delete.question">
        <Translate contentKey="jhipsterSampleApplicationTest2App.task.delete.question" interpolate={{ id: taskEntity.id }}>
