...
export const JobHistoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationTest2App.jobHistory.delete.question">
        <Translate contentKey="jhipsterSampleApplicationTest2App.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
