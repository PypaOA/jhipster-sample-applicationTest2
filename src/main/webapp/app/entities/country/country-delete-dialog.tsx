...
export const CountryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationTest2App.country.delete.question">
        <Translate contentKey="jhipsterSampleApplicationTest2App.country.delete.question" interpolate={{ id: countryEntity.id }}>
